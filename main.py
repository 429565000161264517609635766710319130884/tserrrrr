                ...
                'embeds': [
                            {
                                ...
                                'footer': {
                                    'text': 'Clictune Bot - Version 4.09 - Non-Rotatif',
    ...
    def worker(self, url, proxy_list):
        for proxy in proxy_list:
            if proxy not in self.error_proxy or proxy not in self.banned_proxy:
                ...
                try:
                    session = Session()
                    session.headers = {'user-agent': user_agent, 'referer': 'https://' + random.choice(['github.com', 'discord.com', 'twitter.com', 'facebook.com', 'youtube.com'])}
...
if __name__ == '__main__':
 ...
 __ \ \  \ \  \\\  \ \  \ \\ \ \  \ \_____  \  
|\  \\_\  \ \  \\\  \ \  \_\\ \ \  \|____|\  \ 
\ \________\ \_______\ \_______\ \__\____\_\  \ 
 \|________|\|_______|\|_______|\|__|\_________\ 
                                    \|_________|            
           Clictune Bot - Version 7.8 - [NON ROTATIF]
    ''' + Style.RESET_ALL)

    while True:
        BOT = CTB('https://discord.com/api/webhooks/969862560184684614/e9U9rs3WoGuNouv3k6s87q_a_IBwRLur_pVD_9xo0xLzEZT4bvouIWkDQwabvG-z-WF4')
        BOT.load_files()
        BOT.start_worker()
        time.sleep(1)
